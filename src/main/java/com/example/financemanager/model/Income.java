...
public class Income {
    ...
    private final float entreprise;
    ...
    public Income(LocalDate date, float salary, float help, float entreprise, float passive, float other) {
        this.date = date;
        this.total = salary + help + entreprise + passive + other;
        this.salary = salary;
        this.help = help;
    ...
    public StringProperty entrepriseProperty() {
        return formatAmount(entreprise);
    }

...
public class DashboardController {
    ...
    private Pair<List<Expense>, List<Income>> loadIncomes(LocalDate currentMonth) {
        List<Expense> lastExpensesBar = ExpenseDAO.findLastExpensesEndingAtCurrentMonth(12, currentMonth);
        List<Income> lastIncomesBar = IncomeDAO.findLastIncomeEndingAtCurrentMonth(12, currentMonth);

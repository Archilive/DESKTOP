...
public class IncomeDAO {
    ...
    private static final String entrepriseColumn = "entreprise";
    ...
    public static void insertIncome(Income income) {
        //update database
        String query = "INSERT INTO income(date, salary, help, entreprise, passive, other) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        try (Connection connection = Database.connect()) {
            ...
            statement.setFloat(4, income.getEntreprise());
